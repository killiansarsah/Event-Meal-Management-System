 ...
 * 
 * Usage:
 *   npx ts-node scripts/create-super-admin.ts --email admin@example.com --password SecurePassword123
 * 
 * Or with npx:
 *   npx tsx scripts/create-super-admin.ts --email admin@example.com --password SecurePassword123
 */
...
if (!email || !password) {
  ...
  console.error('');
  console.error('Usage:');
  console.error('  npx tsx scripts/create-super-admin.ts --email admin@example.com --password SecurePassword123 [--name "Full Name"]');
  console.error('');
